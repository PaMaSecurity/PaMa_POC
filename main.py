...
try:
	...
	from PyQt5.QtWidgets import QAction, QApplication, QFrame, QHeaderView, QLabel, QLineEdit, \
		QMainWindow, QMessageBox, QProgressBar, QPushButton, QDialog, QShortcut, QListWidgetItem, \
		QTreeWidgetItem
